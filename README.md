...
-A token is used for authentication, so when things on a site cant be reached without having the required credentials.

- [ ] What steps can you take in your web apps to keep your data secure?

-To keep your web apps secure you could make sure your users are authenticated, and you have the protective routes for the data that is sensitive.

- [ ] Describe how web servers work.

-Web servers is that the server is connected to the browser by a URL and the browser makes request from the server to match the URL, its like they're playing tag.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

- Post - Insert/create,Put - Update, Get- Select/request,Delete-Delete
